...
lyr_Municipaloffice_9.set('fieldLabels', {'Name': 'no label', 'Address': 'no label', 'latitude': 'no label', 'longitude': 'no label', 'Cartegory (Municipal office)': 'inline label - always visible', });
lyr_Banks_10.set('fieldLabels', {'Bank/Institution': 'header label - always visible', 'Location': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'type (Bank)': 'inline label - visible with data', });
